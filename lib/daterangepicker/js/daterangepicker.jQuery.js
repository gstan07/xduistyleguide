...
jQuery.fn.daterangepicker = function(settings){
	...
	var rpPresets = (function(){
		...
		jQuery.each(options.presets, function(key, value) {
			jQuery('<li class="ui-daterangepicker-'+ key +' preset_'+ x +' ui-helper-clearfix ui-corner-all"><span class="icon icon-calendar"></span><a href="#">'+ value +'</a></li>')
			.appendTo(ul);
			x++;
		});
	...
	function showRP(){
		if(rp.data('state') == 'closed'){ 
			positionRP();
			rp.show().data('state', 'open');
			options.onOpen(); 
		}
	}
	function hideRP(){
		if(rp.data('state') == 'open'){ 
			rp.hide().data('state', 'closed');
			options.onClose(); 
		}
	}
	function toggleRP(){
	...
	var doneBtn = jQuery('<button class="btn btn-primary">'+ options.doneButtonText +'</button>')
	.click(function(){
	...
	if(options.arrows && rangeInput.size()==1){
		...
		var prevLink = jQuery('<a href="#" class="ui-daterangepicker-prev ui-corner-all" title="'+ options.prevLinkText +'"><span class="icon icon-circle-arrow-left"></span></a>');
		var nextLink = jQuery('<a href="#" class="ui-daterangepicker-next ui-corner-all" title="'+ options.nextLinkText +'"><span class="icon icon-circle-arrow-right"></span></a>');
